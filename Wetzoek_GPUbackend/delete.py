...
def main():
    ...
    document_store = WeaviateDocumentStore( index=split_doc_index)
    #document_store.delete_documents(filters = {'documentType':['Jurisprudentie']})
    document_store.delete_documents()
...
if __name__ == "__main__":
    main()
    print("careful - this would delete the entire index")